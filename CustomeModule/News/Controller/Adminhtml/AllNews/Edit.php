...
class Edit extends \Magento\Backend\App\Action
{
     ...
     * @param \Magento\Framework\CustomeModule $registry
     */
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('CustomeModule_News::news_allnews')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\CustomeModule\News\Model\Allnews::class);
